...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlUpdate = "UPDATE penjualan SET nama_barang = :nama_barang, jumlah_barang = :jumlah_barang, harga_barang = :harga_barang WHERE id = :id";
        $stmtUpdate = $pdo->prepare($sqlUpdate);
        $stmtUpdate->bindParam(':nama_barang', $nama_barang);
        $stmtUpdate->bindParam(':jumlah_barang', $jumlah_barang);
        $stmtUpdate->bindParam(':harga_barang', $harga_barang);
