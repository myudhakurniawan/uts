...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $sql = "INSERT INTO penjualan (nama_barang, harga_barang, jumlah_barang ) VALUES (:nama_barang, :harga_barang, :jumlah_barang )";
        $stmt = $pdo->prepare($sql);

        // Bind parameter ke statement SQL
        $stmt->bindParam(':nama_barang', $_POST['nama_barang']);
        $stmt->bindParam(':harga_barang', $_POST['harga_barang']);
        $stmt->bindParam(':jumlah_barang', $_POST['jumlah_barang']);
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#pablo"> Tambah Barang </a>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="card">
                                ...
                                <form method="post" action="">
                                        ...
                                        <input class="form-control  mb-3" type="text" placeholder="Harga Barang" name="harga_barang">
                                        <input class="form-control  mb-3" type="text" placeholder="Jumlah Barang" name="jumlah_barang">
