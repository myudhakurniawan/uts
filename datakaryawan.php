                        ...
                        <table class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                echo "<td>" . $row['jk_karyawan'] . "</td>";
                                                echo "<td>" . $row['alamat_karyawan'] . "</td>";
                                                echo "<td>";
                                                echo "<a href='editkaryawan.php?id=" . $row['id'] . "' class='btn btn-sm btn-primary action-button'>Edit</a>";
                                                echo "<a href='hapuskaryawan.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger action-button'>Hapus</a>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                            ?>
