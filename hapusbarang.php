...
try {
    ...
    $sqlDelete = "DELETE FROM penjualan WHERE id = :id";
                        ...
                        <table class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                echo "<td>";
                                                echo "<a href='editbarang.php?id=" . $row['id'] . "' class='btn btn-sm btn-primary action-button'>Edit</a>";
                                                echo "<a href='hapusbarang.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger action-button'>Hapus</a>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                            ?>
